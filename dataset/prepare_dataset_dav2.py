...
if __name__ == '__main__':
    ...
    depth_anything.load_state_dict(torch.load(
        os.path.join('/share/project/algorithm/xiuyu.yang/work/dev6/thirdparty/DepthAnythingV2', f'checkpoints/depth_anything_v2_{encoder}.pth'), map_location='cpu'))
    depth_anything = depth_anything.to(DEVICE).eval()
    
    margin_width = 50
    cmap = matplotlib.colormaps.get_cmap('Spectral_r')

    data_dir = '/share/project/algorithm/xiuyu.yang/work/dev6/data/robonet_preprocessed'
    save_dir = '/share/project/algorithm/xiuyu.yang/work/dev6/data/occ_robonet_dav2/point'
    splits = ['train', 'test']
