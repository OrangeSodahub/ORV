...
def get_labels(data_dir: str, save_dir: str, splits: list, rank: Optional[str] = None):
    ...
    all_captions_file_path = 'data/bridgev2/renderings/captions/all_captions.jsonl'
    all_labels_file_path = 'data/bridgev2/renderings/captions/labels.txt'
    ...
    for split in (pbar1 := tqdm(splits, leave=False, desc='Process split ...')):
        ...
        # points_dir = 'data/bridgev2/renderings/points/train'
        points_dir = 'data/bridgev2/renderings/points/val'
...
if __name__ == '__main__':
    ...
    # ------------------- bridgev2-1 --------------------
    # n_view = 1
    # data_dir = 'data/bridge/videos'
    # save_dir = 'data/bridge/renderings'

    # ------------------- bridgev2-2 --------------------
    n_view = 3
    data_dir = 'data/bridgev2/videos'
    save_dir = 'data/bridgev2/renderings'

    # ------------------- droid --------------------
    # n_view = 2
    # data_dir = 'data/droid/videos'
    # save_dir = 'data/droid/renderings'

    # ------------------- rt1 --------------------
    # n_view = 1
    # data_dir = 'data/rt1/videos'
    # save_dir = 'data/rt1/renderings'
    ...
    if args.action == 'reconstruction':
        ...
        data_dir = 'data/bridgev2/embeddings_full'
        ...
        splits = ['train', 'val']
        # data_dir = 'data/bridge/embeddings_full'
        # data_dir = 'data/droid/embeddings_full'
        # data_dir = 'data/rt1/embeddings_full'
        data_dir = 'data/bridgev2/embeddings_full'
        get_captions(data_dir, save_dir, splits, args.rank)

    elif args.action == 'caption_post_process':
        # data_dir = 'data/bridge/renderings/captions/train/'
        # data_dir = 'data/droid/renderings/captions/train/'
        # data_dir = 'data/rt1/renderings/captions/train/'
        data_dir = 'data/bridgev2/renderings/captions/'
        ...
        # data_dir = 'data/bridge/renderings'
        # data_dir = 'data/droid/renderings'
        # data_dir = 'data/rt1/renderings'
        data_dir = 'data/bridgev2/renderings'
