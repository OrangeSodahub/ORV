...
EXP_CONFIG_PATH="config/traj_image_condfull_2b_finetune.yaml"  # full guidance
# EXP_CONFIG_PATH="config/traj_image_depth_2b_finetune.yaml"
# EXP_CONFIG_PATH="config/traj_image_label_2b_finetune.yaml"
