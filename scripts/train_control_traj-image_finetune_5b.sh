...
# ACCELERATE_CONFIG_FILE="accelerate_configs/L20_4_deepspeed.yaml"
...
EXP_CONFIG_PATH='/share/project/cwm/xiuyu.yang/work/dev6/DiffusionAsShader/config/traj_image_5b_480_320_finetune.yaml'
